...
#ifndef _TAO_IDL_STOCKQUOTERTYPESUPPORTC_SPHMKR_H_
#define _TAO_IDL_STOCKQUOTERTYPESUPPORTC_SPHMKR_H_
...
#define _STOCKQUOTER_EXCHANGEEVENTDATAWRITER__VAR_OUT_CH_
  ...
  private:
    // Private and unimplemented for concrete interfaces.
    ExchangeEventDataWriter (const ExchangeEventDataWriter &);
...
#define _STOCKQUOTER_EXCHANGEEVENTDATAREADER__VAR_OUT_CH_
  ...
  private:
    // Private and unimplemented for concrete interfaces.
    ExchangeEventDataReader (const ExchangeEventDataReader &);
