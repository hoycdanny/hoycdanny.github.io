 ...
 *
 *  $Id: Process_Manual_Event_Test.cpp 2741 2015-11-05 17:34:21Z mitza $
 *
...
#  endif /* AIX */
      ...
      // If argv[0] starts with "/" (absolute path), don't prepend "./":
      if (argc > 0 &&
          ACE_OS::strstr (argv[0], ACE_DIRECTORY_SEPARATOR_STR) == argv[0])
        cmdline_format += 1 + ACE_OS::strlen (ACE_DIRECTORY_SEPARATOR_STR);
