...
#ifndef _TAO_IDL_MESSAGING_POLICYVALUES_KGWN61_H_
#define _TAO_IDL_MESSAGING_POLICYVALUES_KGWN61_H_
...
namespace TAO
{
  ...
  template<>
  class SArg_Traits< ::Messaging::PolicyValue>
    : public
  ...
  template<>
  class SArg_Traits< ::Messaging::PolicyValueSeq>
    : public
        Var_Size_SArg_Traits_T<
