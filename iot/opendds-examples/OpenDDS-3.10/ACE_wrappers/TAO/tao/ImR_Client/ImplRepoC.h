...
#ifndef _TAO_IDL_IMPLREPOC_EDTI1P_H_
#define _TAO_IDL_IMPLREPOC_EDTI1P_H_
...
namespace ImplementationRepository
{
  ...
  TAO_IMR_Client_Export ::CORBA::Boolean operator>>= (const ::CORBA::Any &, ::ImplementationRepository::CannotComplete *&); // deprecated
