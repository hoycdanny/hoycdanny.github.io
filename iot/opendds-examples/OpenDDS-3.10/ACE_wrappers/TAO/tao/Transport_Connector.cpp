// -*- C++ -*-
// $Id: Transport_Connector.cpp 2358 2014-08-29 21:20:47Z mesnierp $
          ...
          if (TAO_debug_level)
            {
              TAOLIB_DEBUG ((LM_DEBUG,
                             ...
                             ACE_TEXT ("found a transport [%d] busy_count = %d\n"),
                             base_transport->id (), busy_count));
            }
      ...
      if (found == TAO::Transport_Cache_Manager::CACHE_FOUND_AVAILABLE)
        {
          if (TAO_debug_level)
            {
              TAOLIB_DEBUG ((LM_DEBUG,
                             ACE_TEXT ("TAO (%P|%t) - TAO_Connector::connect: ")
                             ACE_TEXT ("found a transport [%d] busy_count = %d\n"),
                             base_transport->id (), busy_count));
            }
          ...
          if (TAO_debug_level)
            {
              TAOLIB_DEBUG ((LM_DEBUG,
                             ACE_TEXT ("TAO (%P|%t) - TAO_Connector::connect: ")
                             ACE_TEXT ("make_new_connection = %d busy_count = %d\n"),
                             make_new_connection, busy_count));
            }
