// -*- C++ -*-
// $Id: default_resource.cpp 2646 2015-08-28 00:38:05Z mesnierp $
                                 ...
                                 ACE_TEXT ("-ORBMuxedConnectionMax")) == 0)
      {
        ...
        if (curarg < argc)
          ...
          this->report_option_value_error (ACE_TEXT("-ORBMuxedConnectionMax"),
                                 ...
                                 ACE_TEXT ("-ORBRefreshIORTable")) == 0)
      {
        ++curarg;
        if (curarg < argc)
          this->refresh_IORTable_ = ACE_OS::atoi (argv[curarg]) != 0;
        else
          this->report_option_value_error (ACE_TEXT("-ORBRefreshIORTable"),
                                           argv[curarg]);
      }
    else if (ACE_OS::strcasecmp (argv[curarg],
...
bool
TAO_Default_Resource_Factory::refresh_IORTable (void) const
{
  return this->refresh_IORTable_;
}
