...
#ifndef _TAO_IDL_REQUESTPROCESSINGPOLICYS_61BWXB_H_
#define _TAO_IDL_REQUESTPROCESSINGPOLICYS_61BWXB_H_
...
namespace TAO
{
  ...
  template<>
  class SArg_Traits< ::PortableServer::RequestProcessingPolicyValue>
    : public
        Basic_SArg_Traits_T<
