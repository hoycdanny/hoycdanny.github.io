...
#ifndef _TAO_PIDL_REQUESTPROCESSINGPOLICYC_6AL3RK_H_
#define _TAO_PIDL_REQUESTPROCESSINGPOLICYC_6AL3RK_H_
...
namespace TAO
{
  ...
  template<>
  class Arg_Traits< ::PortableServer::RequestProcessingPolicyValue>
    : public
        Basic_Arg_Traits_T<
