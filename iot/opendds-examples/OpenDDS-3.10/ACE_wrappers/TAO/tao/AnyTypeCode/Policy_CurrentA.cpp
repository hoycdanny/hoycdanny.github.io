...
namespace CORBA
{
  ...
  operator<<= (
      ::CORBA::Any &_tao_any,
      PolicyCurrent_ptr _tao_elem)
  {
    PolicyCurrent_ptr _tao_objptr =
      PolicyCurrent::_duplicate (_tao_elem);
  ...
  operator<<= (
      ...
      PolicyCurrent_ptr *_tao_elem)
  {
    TAO::Any_Impl_T<PolicyCurrent>::insert (
        _tao_any,
        PolicyCurrent::_tao_any_destructor,
        _tc_PolicyCurrent,
        *_tao_elem);
  }
  ...
  {
    return
      TAO::Any_Impl_T<PolicyCurrent>::extract (
          _tao_any,
          PolicyCurrent::_tao_any_destructor,
          _tc_PolicyCurrent,
          _tao_elem);
