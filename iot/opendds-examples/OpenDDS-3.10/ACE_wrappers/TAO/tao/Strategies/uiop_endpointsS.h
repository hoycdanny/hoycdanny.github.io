...
#ifndef _TAO_IDL_UIOP_ENDPOINTSS_IM7K7B_H_
#define _TAO_IDL_UIOP_ENDPOINTSS_IM7K7B_H_
...
namespace TAO
{
  ...
  template<>
  class SArg_Traits< ::TAO_UIOP_Endpoint_Info>
    : public
  ...
  template<>
  class SArg_Traits< ::TAO_UIOPEndpointSequence>
    : public
        Var_Size_SArg_Traits_T<
