...
#ifndef _TAO_IDL_COIOP_ENDPOINTSS_IZZJOU_H_
#define _TAO_IDL_COIOP_ENDPOINTSS_IZZJOU_H_
...
namespace TAO
{
  ...
  template<>
  class SArg_Traits< ::TAO::COIOP_Endpoint_Info>
    : public
  ...
  template<>
  class SArg_Traits< ::TAO::COIOPEndpointSequence>
    : public
        Var_Size_SArg_Traits_T<
