...
#ifndef _TAO_IDL_SCIOP_ENDPOINTSS_ICB41I_H_
#define _TAO_IDL_SCIOP_ENDPOINTSS_ICB41I_H_
...
namespace TAO
{
  ...
  template<>
  class SArg_Traits< ::TAO_SCIOP_Endpoint_Info>
    : public
  ...
  template<>
  class SArg_Traits< ::TAO_SCIOPEndpointSequence>
    : public
        Var_Size_SArg_Traits_T<
