...
# $Id: run_test_ipv6.pl 2777 2015-11-19 21:18:47Z huangh $
# -*- perl -*-
...
$SV = $server_box->CreateProcess ("server", "-o $server_iorfile -u corbaloc:miop:1.0\@1.0-foo-1/[FF05:0:0:0:0:0:25:334]:$port -ORBSvcConf miop_svc_ipv6.conf");
$CL = $client_box->CreateProcess ("client", "-ORBPreferredInterfaces FF05:*=lo -ORBEnforcePreferredInterfaces=1 -ORBSvcConf miop_svc_ipv6.conf -ORBIPMulticastLoop 1 -k corbaloc:miop:1.0\@1.0-foo-1/[FF05:0:0:0:0:0:25:334]:$port");
...
if ($^O ne "MSWin32") {
    ...
    $CL->Arguments("-ORBPreferredInterfaces FF05:*=eth0 -ORBEnforcePreferredInterfaces=1 -ORBIPMulticastLoop 1 -ORBSvcConf miop_svc_ipv6.conf -k file://$client_iorfile");
