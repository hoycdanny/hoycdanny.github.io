// -*- C++ -*-
// $Id: AsyncAccessManager.cpp 2860 2016-06-11 15:05:34Z mesnierp $
                  ...
                  switch (this->status_)
                    ...
                    case  ImplementationRepository::AAM_ACTIVE_TERMINATE:
                      throw ImplementationRepository::CannotActivate
                        ("Server terminating.");
                    default: {
                      ACE_CString reason = "AAM_Status is ";
                      reason += ACE_TEXT_ALWAYS_CHAR (status_name (this->status_));
  ...
  if (ImR_Locator_i::debug () > 4)
    {
      ORBSVCS_DEBUG ((LM_DEBUG,
                      ...
                      this, this->info_->ping_id(), this->info_->pid, this->prev_pid_,
                      status_name (this->status_)));
    }
  this->prev_pid_ = this->info_->pid;
