...
#ifndef _TAO_IDL_IMR_ACTIVATORC_6YM6T1_H_
#define _TAO_IDL_IMR_ACTIVATORC_6YM6T1_H_
...
typedef
  TAO_Objref_Var_T<
    ...
    >
  AMH_ActivatorResponseHandler_var;

typedef
  TAO_Objref_Out_T<
      AMH_ActivatorResponseHandler
    >
  AMH_ActivatorResponseHandler_out;
...
typedef
  TAO_Objref_Var_T<
    ...
    >
  AMI_ActivatorHandler_var;

typedef
  TAO_Objref_Out_T<
      AMI_ActivatorHandler
    >
  AMI_ActivatorHandler_out;
...
typedef
  TAO_Objref_Var_T<
    ...
    >
  AMH_ActivatorExtResponseHandler_var;

typedef
  TAO_Objref_Out_T<
      AMH_ActivatorExtResponseHandler
    >
  AMH_ActivatorExtResponseHandler_out;
...
typedef
  TAO_Objref_Var_T<
    ...
    >
  AMI_ActivatorExtHandler_var;

typedef
  TAO_Objref_Out_T<
      AMI_ActivatorExtHandler
    >
  AMI_ActivatorExtHandler_out;
