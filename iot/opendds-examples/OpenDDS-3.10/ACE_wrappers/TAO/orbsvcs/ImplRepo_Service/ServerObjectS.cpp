...
#ifndef _TAO_IDL_SERVEROBJECTS_2CVJHI_CPP_
#define _TAO_IDL_SERVEROBJECTS_2CVJHI_CPP_
...
/* Command-line: /Users/yc/MyGithub/imac-project/OpenDDS/OpenDDS-3.10/ACE_wrappers/bin/ace_gperf -m -M -J -c -C -D -E -T -f 0 -F 0,0 -a -o -t -p -K opname -L C++ -Z TAO_ImplementationRepository_ServerObject_Perfect_Hash_OpTable -N lookup  */
unsigned int
...
class TAO_ImplementationRepository_AMI_ServerObjectHandler_Perfect_Hash_OpTable
  : public TAO_Perfect_Hash_OpTable
{
private:
  unsigned int hash (const char *str, unsigned int len);
...
/* C++ code produced by gperf version 2.8 (ACE version) */
/* Command-line: /Users/yc/MyGithub/imac-project/OpenDDS/OpenDDS-3.10/ACE_wrappers/bin/ace_gperf -m -M -J -c -C -D -E -T -f 0 -F 0,0 -a -o -t -p -K opname -L C++ -Z TAO_ImplementationRepository_AMI_ServerObjectHandler_Perfect_Hash_OpTable -N lookup  */
unsigned int
TAO_ImplementationRepository_AMI_ServerObjectHandler_Perfect_Hash_OpTable::hash (const char *str, unsigned int len)
{
  static const unsigned char asso_values[] =
    {
...
const TAO_operation_db_entry *
TAO_ImplementationRepository_AMI_ServerObjectHandler_Perfect_Hash_OpTable::lookup (const char *str, unsigned int len)
{
  enum
    {
      TOTAL_KEYWORDS = 7,
  ...
  static const TAO_operation_db_entry wordlist[] =
    {
      {"",0,0},{"",0,0},{"",0,0},{"",0,0},
      {"ping", &POA_ImplementationRepository::AMI_ServerObjectHandler::ping_skel, &POA_ImplementationRepository::_TAO_AMI_ServerObjectHandler_Direct_Proxy_Impl::ping},
      {"_is_a", &TAO_ServantBase::_is_a_thru_poa_skel, 0},
      {"",0,0},{"",0,0},{"",0,0},{"",0,0},
      {"ping_excep", &POA_ImplementationRepository::AMI_ServerObjectHandler::ping_excep_skel, &POA_ImplementationRepository::_TAO_AMI_ServerObjectHandler_Direct_Proxy_Impl::ping_excep},
      {"",0,0},{"",0,0},{"",0,0},
      {"_repository_id", &TAO_ServantBase::_repository_id_thru_poa_skel, 0},
      {"_interface", &TAO_ServantBase::_interface_skel, 0},
      {"",0,0},
...
static TAO_ImplementationRepository_AMI_ServerObjectHandler_Perfect_Hash_OpTable tao_ImplementationRepository_AMI_ServerObjectHandler_optable;

///////////////////////////////////////////////////////////////////////
//                 Direct Proxy  Implementation
//

POA_ImplementationRepository::_TAO_AMI_ServerObjectHandler_Direct_Proxy_Impl::~_TAO_AMI_ServerObjectHandler_Direct_Proxy_Impl (void)
{
}
...
// be/be_visitor_operation/direct_proxy_impl_ss.cpp:59
void
POA_ImplementationRepository::_TAO_AMI_ServerObjectHandler_Direct_Proxy_Impl::ping (
    TAO_Abstract_ServantBase  *servant,
    TAO::Argument **)
  
{
  POA_ImplementationRepository::AMI_ServerObjectHandler_ptr _tao_ptr = 
    dynamic_cast<POA_ImplementationRepository::AMI_ServerObjectHandler_ptr> (servant);
  if (!_tao_ptr)
    {
      throw ::CORBA::INTERNAL ();
    }
...
// be/be_visitor_operation/direct_proxy_impl_ss.cpp:59
void
POA_ImplementationRepository::_TAO_AMI_ServerObjectHandler_Direct_Proxy_Impl::ping_excep (
    TAO_Abstract_ServantBase  *servant,
    TAO::Argument ** args)
...
POA_ImplementationRepository::AMI_ServerObjectHandler::AMI_ServerObjectHandler (void)
  : TAO_ServantBase ()
{
  this->optable_ = &tao_ImplementationRepository_AMI_ServerObjectHandler_optable;
}

POA_ImplementationRepository::AMI_ServerObjectHandler::AMI_ServerObjectHandler (const AMI_ServerObjectHandler& rhs)
  : TAO_Abstract_ServantBase (rhs),
    TAO_ServantBase (rhs),
...
namespace POA_ImplementationRepository
{
  ...
  class ping_AMI_ServerObjectHandler
    : public TAO::Upcall_Command
  {
  public:
    inline ping_AMI_ServerObjectHandler (
      POA_ImplementationRepository::AMI_ServerObjectHandler * servant)
      : servant_ (servant)
    {
    }
  ...
  private:
    POA_ImplementationRepository::AMI_ServerObjectHandler * const servant_;
  };
}
...
void POA_ImplementationRepository::AMI_ServerObjectHandler::ping_skel (
  TAO_ServerRequest & server_request,
  TAO::Portable_Server::Servant_Upcall *TAO_INTERCEPTOR (servant_upcall),
  TAO_ServantBase *servant)
{
  ...
  POA_ImplementationRepository::AMI_ServerObjectHandler * const impl =
    dynamic_cast<POA_ImplementationRepository::AMI_ServerObjectHandler *> (servant);
  ...
  ping_AMI_ServerObjectHandler command (
    impl);
...
namespace POA_ImplementationRepository
{
  ...
  class ping_excep_AMI_ServerObjectHandler
    : public TAO::Upcall_Command
  {
  public:
    inline ping_excep_AMI_ServerObjectHandler (
      POA_ImplementationRepository::AMI_ServerObjectHandler * servant,
...
void POA_ImplementationRepository::AMI_ServerObjectHandler::ping_excep_skel (
  TAO_ServerRequest & server_request,
  TAO::Portable_Server::Servant_Upcall *TAO_INTERCEPTOR (servant_upcall),
  TAO_ServantBase *servant)
{
  ...
  ping_excep_AMI_ServerObjectHandler command (
    impl,
...
::CORBA::Boolean POA_ImplementationRepository::AMI_ServerObjectHandler::_is_a (const char* value)
{
  return
    (
      ACE_OS::strcmp (
...
const char* POA_ImplementationRepository::AMI_ServerObjectHandler::_interface_repository_id (void) const
{
...
void POA_ImplementationRepository::AMI_ServerObjectHandler::_dispatch (
  TAO_ServerRequest & req,
  TAO::Portable_Server::Servant_Upcall* servant_upcall)
{
  this->synchronous_upcall_dispatch (req, servant_upcall, this);
...
ImplementationRepository::AMI_ServerObjectHandler *
POA_ImplementationRepository::AMI_ServerObjectHandler::_this (void)
{
  TAO_Stub *stub = this->_create_stub ();
  ...
  typedef ::ImplementationRepository::AMI_ServerObjectHandler STUB_SCOPED_NAME;
  return
    TAO::Narrow_Utils<STUB_SCOPED_NAME>::unchecked_narrow (
        obj.in ());
}
