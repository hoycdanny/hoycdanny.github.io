 ...
 *
 *  $Id: FT_Storable_Naming_Context_Factory.h 2853 2016-06-07 02:19:22Z mesnierp $
 *
...
public:
  ...
  TAO_FT_Storable_Naming_Context_Factory (
                                          ...
                                          FT_Naming_Replication_Manager * rep = 0);

  /// Destructor.  Does not deallocate the hash map: if an instance of
  /// this class goes out of scope, its hash_map remains in persistent storage.
  virtual ~TAO_FT_Storable_Naming_Context_Factory (void);

  FT_Naming_Replication_Manager * replicator (void);
