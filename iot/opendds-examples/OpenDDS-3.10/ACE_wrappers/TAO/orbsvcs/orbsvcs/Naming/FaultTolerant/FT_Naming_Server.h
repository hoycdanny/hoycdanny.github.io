 ...
 *
 * $Id: FT_Naming_Server.h 2860 2016-06-11 15:05:34Z mesnierp $
 *
...
{
public:
  TAO_FTNS_Notifier (TAO_FT_Naming_Server &owner);

  virtual int handle_exception (ACE_HANDLE );

  TAO_FT_Naming_Server &owner_;
  FT_Naming::ReplicaInfo iors_;
  bool iors_pending_;
  FT_Naming::UpdateInfoSeq infos_;
};
...
/// Setup pairing with peer replica.
  ...
  void update_info (const FT_Naming::UpdateInfoSeq &infos);
...
protected:
  ...
  /// interface.
  FT_Naming_Replication_Manager* replicator_;
