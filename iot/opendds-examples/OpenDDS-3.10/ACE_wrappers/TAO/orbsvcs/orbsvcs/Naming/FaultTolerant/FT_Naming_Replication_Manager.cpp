 ...
 *
 * $Id: FT_Naming_Replication_Manager.cpp 2860 2016-06-11 15:05:34Z mesnierp $
 *
 * @author Phil Mesnier
 */
//=============================================================================
...
FT_Update_Replicant_i::FT_Update_Replicant_i (FT_Naming_Replication_Manager &owner)
  :owner_ (owner)
{
}
...
FT_Naming_Replication_Manager::FT_Naming_Replication_Manager (TAO_FT_Naming_Server &owner)
  : me_ (),
    peer_ (),
    seq_num_ (0),
    replica_seq_num_ (0),
...
FT_Naming_Replication_Manager::~FT_Naming_Replication_Manager()
{
}

void
FT_Naming_Replication_Manager::init_orb (void)
{
  int argc = 8;
  ACE_TCHAR *argv[11];
...
char *
FT_Naming_Replication_Manager::ior (void)
{
  return this->orb_->object_to_string (this->me_.in ());
}

bool
FT_Naming_Replication_Manager::peer_available (void)
{
  return !CORBA::is_nil (this->peer_.in ());
}

void
FT_Naming_Replication_Manager::stop (void)
{
  if (this->reactor_ == 0)
    {
      return;
...
int
FT_Naming_Replication_Manager::svc (void)
{
  if (this->reactor_ == 0)
    {
      return 0;
  ...
  try
  ...
  catch (const CORBA::SystemException &ex)
    {
      if (TAO_debug_level > 0)
        {
          ORBSVCS_DEBUG ((LM_DEBUG,
                         ACE_TEXT ("(%P|%t) FT_Naming_Replication_Manager::svc caught %C\n"),
                          ex._name ()));
        }
    }
  return 0;
...
int
FT_Naming_Replication_Manager::handle_exception (ACE_HANDLE )
{
...
void
FT_Naming_Replication_Manager::send_objgrp_update (PortableGroup::ObjectGroupId id,
...
void
FT_Naming_Replication_Manager::send_context_update (const ACE_CString & name,
                                    FT_Naming::ChangeType change)
{
  if (this->reactor_ == 0)
    {
...
void
FT_Naming_Replication_Manager::send_registration (bool use_combo_refs)
{
...
bool
FT_Naming_Replication_Manager::peer_init_i (void)
{
...
bool
FT_Naming_Replication_Manager::update_peer_registration (void)
{
...
bool
FT_Naming_Replication_Manager::init_peer (void)
{
