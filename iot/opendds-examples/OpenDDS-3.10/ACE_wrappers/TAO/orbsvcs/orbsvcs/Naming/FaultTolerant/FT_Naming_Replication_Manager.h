...
private:
  FT_Naming_Replication_Manager &owner_;
};
...
class FT_Naming_Replication_Manager : public ACE_Task_Base
{
public:
  ...
  FT_Naming_Replication_Manager (TAO_FT_Naming_Server &owner);

  virtual ~FT_Naming_Replication_Manager(void);
