// $Id: Process.cpp 2761 2015-11-11 22:04:04Z mitza $
...
ACE_Process_Options::setenv (const ACE_TCHAR *format, ...)
{
  ...
  ACE_OS::vsnprintf (stack_buf, DEFAULT_COMMAND_LINE_BUF_LEN, format, argp);
  // End varargs.
  va_end (argp);
                             ...
                             const ACE_TCHAR *format, ...)
{
  ...
  ACE_OS::snprintf (safe_newformat.get (), buflen, ACE_TEXT ("%s=%s"),
