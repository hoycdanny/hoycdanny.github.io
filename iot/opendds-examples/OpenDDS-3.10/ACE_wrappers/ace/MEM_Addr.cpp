// $Id: MEM_Addr.cpp 2770 2015-11-18 18:24:45Z huangh $
...
ACE_MEM_Addr::same_host (const ACE_INET_Addr &sap)
{
  ...
  if (sap.is_loopback())
      // Some Linux distrubitons put a 127.0.1.1 entry in /etc/hosts file.
      // This check can avoid the problem associated with the practice.
      return 1;
