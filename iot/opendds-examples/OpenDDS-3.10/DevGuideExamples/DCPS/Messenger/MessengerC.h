...
#ifndef _TAO_IDL_MESSENGERC_EJH5ZA_H_
#define _TAO_IDL_MESSENGERC_EJH5ZA_H_
...
namespace Messenger
{
   ...
   ::CORBA::Boolean operator>>= (const ::CORBA::Any &, ::Messenger::Message *&); // deprecated
