...
void gen_find_size(const Messenger::Message& stru, size_t& size, size_t& padding)
{
  ...
  find_size_ulong(size, padding);
  size += ACE_OS::strlen(stru.dataee.in()) + 1;
  if ((size + padding) % 4) {
    padding += 4 - ((size + padding) % 4);
  }
...
struct MetaStructImpl<Messenger::Message> : MetaStruct {
  ...
  Value getValue(const void* stru, const char* field) const
  {
    ...
    if (std::strcmp(field, "dataee") == 0) {
      return typed.dataee.in();
    }
  ...
  Value getValue(Serializer& ser, const char* field) const
  {
    ...
    if (std::strcmp(field, "dataee") == 0) {
      TAO::String_Manager val;
      if (!(ser >> val.out())) {
        throw std::runtime_error("Field 'dataee' could not be deserialized");
      }
      return val;
    } else {
      ACE_CDR::ULong len;
      if (!(ser >> len)) {
        throw std::runtime_error("String 'dataee' length could not be deserialized");
      }
      ser.skip(len);
    }
    if (std::strcmp(field, "count") == 0) {
  ...
  ComparatorBase::Ptr create_qc_comparator(const char* field, ComparatorBase::Ptr next) const
  {
    ...
    if (std::strcmp(field, "dataee") == 0) {
      return make_field_cmp(&T::dataee, next);
    }
    if (std::strcmp(field, "count") == 0) {
  ...
  {
    static const char* names[] = {"from", "subject", "subject_id", "dataee", "count", 0};
    return names;
  }
  ...
  const void* getRawField(const void* stru, const char* field) const
  {
    ...
    if (std::strcmp(field, "dataee") == 0) {
      return &static_cast<const T*>(stru)->dataee;
    }
    if (std::strcmp(field, "count") == 0) {
    ...
    const char* rhsFieldSpec, const MetaStruct& rhsMeta) const
  {
    ...
    if (std::strcmp(field, "dataee") == 0) {
      static_cast<T*>(lhs)->dataee = *static_cast<const TAO::String_Manager*>(rhsMeta.getRawField(rhs, rhsFieldSpec));
      return;
    }
    if (std::strcmp(field, "count") == 0) {
  ...
  bool compare(const void* lhs, const void* rhs, const char* field) const
  {
    ...
    if (std::strcmp(field, "dataee") == 0) {
      return 0 == ACE_OS::strcmp(static_cast<const T*>(lhs)->dataee.in(), static_cast<const T*>(rhs)->dataee.in());
    }
    if (std::strcmp(field, "count") == 0) {
