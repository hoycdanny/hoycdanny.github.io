...
#ifndef OPENDDS_IDL_GENERATED_BAZDEF_TS_HPP_8WVCPV
#define OPENDDS_IDL_GENERATED_BAZDEF_TS_HPP_8WVCPV
#include "BazDefC.h"
#include "FACE/TS.hpp"
namespace FACE
{
  ...
  {
    typedef void (*send_event_Xyz_Baz_Ptr) (
      /* in */ TRANSACTION_ID_TYPE transaction_id,
      /* inout */ Xyz::Baz& message,
  ...
  namespace TS
  {
    ...
    void Register_Callback(
      /* in */ CONNECTION_ID_TYPE connection_id,
      /* in */ const WAITSET_TYPE waitset,
      /* in */ Read_Callback::send_event_Xyz_Baz_Ptr data_callback,
...
#endif /* OPENDDS_IDL_GENERATED_BAZDEF_TS_HPP_8WVCPV */
