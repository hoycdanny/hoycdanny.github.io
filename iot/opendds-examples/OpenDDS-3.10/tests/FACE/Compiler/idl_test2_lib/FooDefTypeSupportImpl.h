...
#ifndef OPENDDS_IDL_GENERATED_FOODEFTYPESUPPORTIMPL_H_YDHAVI
#define OPENDDS_IDL_GENERATED_FOODEFTYPESUPPORTIMPL_H_YDHAVI
#include "FooDefC.h"
...
/* End STRUCT: Bar */
#endif /* OPENDDS_IDL_GENERATED_FOODEFTYPESUPPORTIMPL_H_YDHAVI */
