...
#ifndef OPENDDS_IDL_GENERATED_FIXED_TS_HPP_QYOS4O
#define OPENDDS_IDL_GENERATED_FIXED_TS_HPP_QYOS4O
#include "FixedC.h"
#include "FACE/TS.hpp"
namespace FACE
{
  ...
  {
    typedef void (*send_event_M1_S1_Ptr) (
  ...
  namespace TS
  {
    ...
    void Register_Callback(
      /* in */ CONNECTION_ID_TYPE connection_id,
      /* in */ const WAITSET_TYPE waitset,
      /* in */ Read_Callback::send_event_M1_S1_Ptr data_callback,
...
#endif /* OPENDDS_IDL_GENERATED_FIXED_TS_HPP_QYOS4O */
