...
#endif
namespace Xyz {
ArrayOfShorts_slice* ArrayOfShorts_alloc()
{
  void* const raw = ACE_Allocator::instance()->malloc(sizeof(ArrayOfShorts));
  ArrayOfShorts_slice* const slice = static_cast<ArrayOfShorts_slice*>(raw);
  ArrayOfShorts_init_i(slice);
  return slice;
}

void ArrayOfShorts_init_i(::FACE::Short* begin)
{
  ACE_UNUSED_ARG(begin);
}

void ArrayOfShorts_fini_i(::FACE::Short* begin)
{
  ACE_UNUSED_ARG(begin);
}

void ArrayOfShorts_free(ArrayOfShorts_slice* slice)
{
  if (!slice) return;
  ArrayOfShorts_fini_i(slice);
  ACE_Allocator::instance()->free(slice);
}

ArrayOfShorts_slice* ArrayOfShorts_dup(const ArrayOfShorts_slice* slice)
{
  ArrayOfShorts_slice* const arr = ArrayOfShorts_alloc();
  if (arr) ArrayOfShorts_copy(arr, slice);
  return arr;
}

void ArrayOfShorts_copy(ArrayOfShorts_slice* dst, const ArrayOfShorts_slice* src)
{
  if (!src || !dst) return;
...
#endif
namespace Xyz {
ArrayOfShorts2_slice* ArrayOfShorts2_alloc()
{
  void* const raw = ACE_Allocator::instance()->malloc(sizeof(ArrayOfShorts2));
  ArrayOfShorts2_slice* const slice = static_cast<ArrayOfShorts2_slice*>(raw);
  ArrayOfShorts2_init_i(slice);
  return slice;
}

void ArrayOfShorts2_init_i(::FACE::Short* begin)
{
  ACE_UNUSED_ARG(begin);
}

void ArrayOfShorts2_fini_i(::FACE::Short* begin)
{
  ACE_UNUSED_ARG(begin);
}

void ArrayOfShorts2_free(ArrayOfShorts2_slice* slice)
{
  if (!slice) return;
  ArrayOfShorts2_fini_i(slice);
  ACE_Allocator::instance()->free(slice);
}

ArrayOfShorts2_slice* ArrayOfShorts2_dup(const ArrayOfShorts2_slice* slice)
{
  ArrayOfShorts2_slice* const arr = ArrayOfShorts2_alloc();
  if (arr) ArrayOfShorts2_copy(arr, slice);
  return arr;
}

void ArrayOfShorts2_copy(ArrayOfShorts2_slice* dst, const ArrayOfShorts2_slice* src)
{
  if (!src || !dst) return;
...
#endif
namespace Xyz {
MultiDimArray_slice* MultiDimArray_alloc()
{
  void* const raw = ACE_Allocator::instance()->malloc(sizeof(MultiDimArray));
  MultiDimArray_slice* const slice = static_cast<MultiDimArray_slice*>(raw);
  MultiDimArray_init_i(slice[0][0][0]);
  return slice;
}

void MultiDimArray_init_i(::OpenDDS::FaceTypes::String_mgr* begin)
{
  std::uninitialized_fill_n(begin, 2 * 3 * 4 * 5, ::OpenDDS::FaceTypes::String_mgr());
}

void MultiDimArray_fini_i(::OpenDDS::FaceTypes::String_mgr* begin)
{
...
void MultiDimArray_free(MultiDimArray_slice* slice)
{
  if (!slice) return;
  MultiDimArray_fini_i(slice[0][0][0]);
  ACE_Allocator::instance()->free(slice);
}

MultiDimArray_slice* MultiDimArray_dup(const MultiDimArray_slice* slice)
{
  MultiDimArray_slice* const arr = MultiDimArray_alloc();
  if (arr) MultiDimArray_copy(arr, slice);
  return arr;
}

void MultiDimArray_copy(MultiDimArray_slice* dst, const MultiDimArray_slice* src)
{
  if (!src || !dst) return;
  for (ACE_CDR::ULong i0 = 0; i0 < 2; ++i0) {
    for (ACE_CDR::ULong i1 = 0; i1 < 3; ++i1) {
      for (ACE_CDR::ULong i2 = 0; i2 < 4; ++i2) {
        for (ACE_CDR::ULong i3 = 0; i3 < 5; ++i3) {
...
#endif
namespace Xyz {
bool StructOfMultiDimArray::operator==(const StructOfMultiDimArray& rhs) const
{
  for (int i0 = 0; i0 < 2; ++i0) {
    for (int i1 = 0; i1 < 3; ++i1) {
      for (int i2 = 0; i2 < 4; ++i2) {
        for (int i3 = 0; i3 < 5; ++i3) {
          if (mda[i0][i1][i2][i3] != rhs.mda[i0][i1][i2][i3]) {
            return false;
          }
        }
      }
...
void swap(StructOfMultiDimArray& lhs, StructOfMultiDimArray& rhs)
{
  using std::swap;
  std::swap_ranges(lhs.mda[0][0][0], lhs.mda[0][0][0] + 120, rhs.mda[0][0][0]);
}

ACE_CDR::Boolean operator<< (ACE_OutputCDR &, const StructOfMultiDimArray&) { return true; }

ACE_CDR::Boolean operator>> (ACE_InputCDR &, StructOfMultiDimArray&) { return true; }
...
#endif
namespace Xyz {
ArrayOfArrayOfShorts2_slice* ArrayOfArrayOfShorts2_alloc()
{
  void* const raw = ACE_Allocator::instance()->malloc(sizeof(ArrayOfArrayOfShorts2));
  ArrayOfArrayOfShorts2_slice* const slice = static_cast<ArrayOfArrayOfShorts2_slice*>(raw);
  ArrayOfArrayOfShorts2_init_i(slice);
  return slice;
}

void ArrayOfArrayOfShorts2_init_i(Xyz::ArrayOfShorts2* begin)
{
  for (ACE_CDR::ULong i0 = 0; i0 < 3; ++i0) {
    Xyz::ArrayOfShorts2_init_i(begin[i0]);
  }
}

void ArrayOfArrayOfShorts2_fini_i(Xyz::ArrayOfShorts2* begin)
{
  for (ACE_CDR::ULong i0 = 0; i0 < 3; ++i0) {
    Xyz::ArrayOfShorts2_fini_i(begin[i0]);
  }
}

void ArrayOfArrayOfShorts2_free(ArrayOfArrayOfShorts2_slice* slice)
{
  if (!slice) return;
  ArrayOfArrayOfShorts2_fini_i(slice);
  ACE_Allocator::instance()->free(slice);
}

ArrayOfArrayOfShorts2_slice* ArrayOfArrayOfShorts2_dup(const ArrayOfArrayOfShorts2_slice* slice)
{
  ArrayOfArrayOfShorts2_slice* const arr = ArrayOfArrayOfShorts2_alloc();
  if (arr) ArrayOfArrayOfShorts2_copy(arr, slice);
  return arr;
}

void ArrayOfArrayOfShorts2_copy(ArrayOfArrayOfShorts2_slice* dst, const ArrayOfArrayOfShorts2_slice* src)
{
  if (!src || !dst) return;
  for (ACE_CDR::ULong i0 = 0; i0 < 3; ++i0) {
    Xyz::ArrayOfShorts2_copy(dst[i0], src[i0]);
  }
}
...
#endif
namespace Xyz {
bool StructOfArrayOfArrayOfShorts2::operator==(const StructOfArrayOfArrayOfShorts2& rhs) const
{
  for (int i0 = 0; i0 < 3; ++i0) {
    for (int i1 = 0; i1 < 3; ++i1) {
      if (f1[i0][i1] != rhs.f1[i0][i1]) {
        return false;
      }
    }
  }
...
ACE_CDR::Boolean operator<< (ACE_OutputCDR &, const StructOfArrayOfArrayOfShorts2&) { return true; }

ACE_CDR::Boolean operator>> (ACE_InputCDR &, StructOfArrayOfArrayOfShorts2&) { return true; }
...
AUnion::AUnion(const AUnion& other) {
  ...
  case Xyz::redx:
    {
    this->_u.rsv = (other._u.rsv) ? ::CORBA::string_dup(other._u.rsv) : 0 ;
      break;
    }
  case Xyz::greenx:
    {
    this->_u.gsv = (other._u.gsv) ? new Xyz::AStruct(*other._u.gsv) : 0;
      break;
    }
  default:
    {
    this->_u.usv = other._u.usv;
      break;
    }
  }
}
...
bool AUnion::operator==(const AUnion& rhs) const
{
  ...
  case Xyz::redx:
    {
      return std::strcmp (this->_u.rsv, rhs._u.rsv) == 0 ;
      break;
    }
  case Xyz::greenx:
    {
      return *this->_u.gsv == *rhs._u.gsv;
      break;
    }
  default:
    {
      return this->_u.usv == rhs._u.usv;
      break;
    }
  }
    return false;
...
void ArrayOfAStructSeq_init_i(Xyz::AStructSeqX* begin)
{
  std::uninitialized_fill_n(begin, 3, Xyz::AStructSeqX());
}

void ArrayOfAStructSeq_fini_i(Xyz::AStructSeqX* begin)
{
  for (int i = 0; i < 3; ++i) {
    begin[i].~AStructSeqX();
  }
...
void swap(Foo& lhs, Foo& rhs)
{
  ...
  swap(lhs.ushrtseq, rhs.ushrtseq);
...
#endif
namespace Xyz {
bool StructWithTypedefedEnum::operator==(const StructWithTypedefedEnum& rhs) const
{
  if (tte != rhs.tte) {
    return false;
  }
...
ACE_CDR::Boolean operator<< (ACE_OutputCDR &, const StructWithTypedefedEnum&) { return true; }

ACE_CDR::Boolean operator>> (ACE_InputCDR &, StructWithTypedefedEnum&) { return true; }
...
#endif
namespace Xyz {
TestUnion::TestUnion() { std::memset (this, 0, sizeof (TestUnion)); }

TestUnion::TestUnion(const TestUnion& other) {
  this->_discriminator = other._discriminator;
  if (this->_discriminator) 
    {
    this->_u.swte = (other._u.swte) ? new Xyz::StructWithTypedefedEnum(*other._u.swte) : 0;
    }
  else 
    {
    this->_u.te = other._u.te;
    }
}

TestUnion& TestUnion::operator=(const TestUnion& other) {
  if (this != &other) {
    _reset();
    this->_discriminator = other._discriminator;
  if (this->_discriminator) 
...
bool TestUnion::operator==(const TestUnion& rhs) const
{
  ...
  if (this->_discriminator) 
    {
      return *this->_u.swte == *rhs._u.swte;
    }
  else 
    {
      return this->_u.te == rhs._u.te;
    }
    return false;
  }
...
ACE_CDR::Boolean operator<< (ACE_OutputCDR &, const TestUnion&) { return true; }

ACE_CDR::Boolean operator>> (ACE_InputCDR &, TestUnion&) { return true; }
...
#endif
namespace N1 {
bool FwdDeclStruct::operator==(const FwdDeclStruct& rhs) const
{
  if (v1 != rhs.v1) {
    return false;
  }
...
ACE_CDR::Boolean operator<< (ACE_OutputCDR &, const FwdDeclStruct&) { return true; }

ACE_CDR::Boolean operator>> (ACE_InputCDR &, FwdDeclStruct&) { return true; }
...
ACE_CDR::Boolean operator<< (ACE_OutputCDR &, const Bar&) { return true; }

ACE_CDR::Boolean operator>> (ACE_InputCDR &, Bar&) { return true; }
