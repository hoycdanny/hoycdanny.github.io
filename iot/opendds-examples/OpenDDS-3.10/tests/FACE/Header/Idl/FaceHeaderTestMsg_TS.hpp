...
#ifndef OPENDDS_IDL_GENERATED_FACEHEADERTESTMSG_TS_HPP_YKHAXG
#define OPENDDS_IDL_GENERATED_FACEHEADERTESTMSG_TS_HPP_YKHAXG
...
namespace FACE
{
  ...
  {
    typedef void (*send_event_HeaderTest_Message_Ptr) (
      /* in */ TRANSACTION_ID_TYPE transaction_id,
      /* inout */ HeaderTest::Message& message,
  ...
  namespace TS
  {
    ...
    void Receive_Message(
      ...
      /* out */ HeaderTest::Message& message,
      /* in */ MESSAGE_SIZE_TYPE message_size,
      /* out */ RETURN_CODE_TYPE& return_code);
    ...
    void Register_Callback(
      /* in */ CONNECTION_ID_TYPE connection_id,
      /* in */ const WAITSET_TYPE waitset,
      /* in */ Read_Callback::send_event_HeaderTest_Message_Ptr data_callback,
...
#endif /* OPENDDS_IDL_GENERATED_FACEHEADERTESTMSG_TS_HPP_YKHAXG */
