...
void gen_find_size(const HeaderTest::Message& stru, size_t& size, size_t& padding)
{
  ...
  size += gen_max_marshaled_size(stru.msg_instance_guid);
}
...
template<>
struct MetaStructImpl<HeaderTest::Message> : MetaStruct {
  typedef HeaderTest::Message T;
  ...
  {
    const HeaderTest::Message& typed = *static_cast<const HeaderTest::Message*>(stru);
    ...
    if (std::strcmp(field, "msg_instance_guid") == 0) {
      return typed.msg_instance_guid;
    }
    ACE_UNUSED_ARG(typed);
    throw std::runtime_error("Field " + OPENDDS_STRING(field) + " not found or its type is not supported (in struct HeaderTest::Message)");
  }
  ...
  Value getValue(Serializer& ser, const char* field) const
  {
    ...
    if (std::strcmp(field, "msg_instance_guid") == 0) {
      ...
      if (!(ser >> val)) {
        throw std::runtime_error("Field 'msg_instance_guid' could not be deserialized");
      }
      return val;
    } else {
      ser.skip(1, 8);
    ...
    throw std::runtime_error("Field " + OPENDDS_STRING(field) + " not valid for struct HeaderTest::Message");
  }
  ...
  ComparatorBase::Ptr create_qc_comparator(const char* field, ComparatorBase::Ptr next) const
  {
    ...
    if (std::strcmp(field, "msg_instance_guid") == 0) {
      return make_field_cmp(&T::msg_instance_guid, next);
    }
    throw std::runtime_error("Field " + OPENDDS_STRING(field) + " not found or its type is not supported (in struct HeaderTest::Message)");
  }
  ...
  {
    static const char* names[] = {"text", "count", "msg_instance_guid", 0};
    return names;
  }
  ...
  const void* getRawField(const void* stru, const char* field) const
  {
    ...
    if (std::strcmp(field, "msg_instance_guid") == 0) {
      return &static_cast<const T*>(stru)->msg_instance_guid;
    }
    throw std::runtime_error("Field " + OPENDDS_STRING(field) + " not found or its type is not supported (in struct HeaderTest::Message)");
  }
    ...
    const char* rhsFieldSpec, const MetaStruct& rhsMeta) const
  {
    ...
    if (std::strcmp(field, "msg_instance_guid") == 0) {
      static_cast<T*>(lhs)->msg_instance_guid = *static_cast<const CORBA::LongLong*>(rhsMeta.getRawField(rhs, rhsFieldSpec));
      return;
    }
    throw std::runtime_error("Field " + OPENDDS_STRING(field) + " not found or its type is not supported (in struct HeaderTest::Message)");
  }
  ...
  bool compare(const void* lhs, const void* rhs, const char* field) const
  {
    ...
    if (std::strcmp(field, "msg_instance_guid") == 0) {
      return static_cast<const T*>(lhs)->msg_instance_guid == static_cast<const T*>(rhs)->msg_instance_guid;
    }
    throw std::runtime_error("Field " + OPENDDS_STRING(field) + " not found or its type is not supported (in struct HeaderTest::Message)");
  }
};
...
{
  static MetaStructImpl<HeaderTest::Message> msi;
  return msi;
}
...
{
  ACE_UNUSED_ARG(ser);
  MetaStructImpl<HeaderTest::Message>().getValue(ser, "");
}
...
bool Message::operator==(const Message& rhs) const
{
  ...
  if (msg_instance_guid != rhs.msg_instance_guid) {
    return false;
  }
  return true;
}
...
void swap(Message& lhs, Message& rhs)
{
  ...
  swap(lhs.msg_instance_guid, rhs.msg_instance_guid);
}
