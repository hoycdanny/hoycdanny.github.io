...
void gen_find_size(const Messenger::Message& stru, size_t& size, size_t& padding)
{
  ...
  size += gen_max_marshaled_size(stru.strength);
}
...
struct MetaStructImpl<Messenger::Message> : MetaStruct {
  ...
  Value getValue(const void* stru, const char* field) const
  {
    ...
    if (std::strcmp(field, "strength") == 0) {
      return typed.strength;
    }
  ...
  Value getValue(Serializer& ser, const char* field) const
  {
    ...
    if (std::strcmp(field, "strength") == 0) {
      ACE_CDR::Long val;
      if (!(ser >> val)) {
        throw std::runtime_error("Field 'strength' could not be deserialized");
      }
      return val;
    } else {
      ser.skip(1, 4);
  ...
  ComparatorBase::Ptr create_qc_comparator(const char* field, ComparatorBase::Ptr next) const
  {
    ...
    if (std::strcmp(field, "strength") == 0) {
      return make_field_cmp(&T::strength, next);
    }
    throw std::runtime_error("Field " + OPENDDS_STRING(field) + " not found or its type is not supported (in struct Messenger::Message)");
  }
  ...
  {
    static const char* names[] = {"from", "subject", "subject_id", "text", "count", "strength", 0};
    return names;
  }
  ...
  const void* getRawField(const void* stru, const char* field) const
  {
    ...
    if (std::strcmp(field, "strength") == 0) {
      return &static_cast<const T*>(stru)->strength;
    }
    throw std::runtime_error("Field " + OPENDDS_STRING(field) + " not found or its type is not supported (in struct Messenger::Message)");
  }
    ...
    const char* rhsFieldSpec, const MetaStruct& rhsMeta) const
  {
    ...
    if (std::strcmp(field, "strength") == 0) {
      static_cast<T*>(lhs)->strength = *static_cast<const CORBA::Long*>(rhsMeta.getRawField(rhs, rhsFieldSpec));
      return;
    }
    throw std::runtime_error("Field " + OPENDDS_STRING(field) + " not found or its type is not supported (in struct Messenger::Message)");
  }
  ...
  bool compare(const void* lhs, const void* rhs, const char* field) const
  {
    ...
    if (std::strcmp(field, "strength") == 0) {
      return static_cast<const T*>(lhs)->strength == static_cast<const T*>(rhs)->strength;
    }
    throw std::runtime_error("Field " + OPENDDS_STRING(field) + " not found or its type is not supported (in struct Messenger::Message)");
  }
};
