...
#ifndef OPENDDS_IDL_GENERATED_MESSENGERTYPESUPPORTIMPL_H_EXGHPX
#define OPENDDS_IDL_GENERATED_MESSENGERTYPESUPPORTIMPL_H_EXGHPX
...
struct Lifespan_Export Message_OpenDDS_KeyLessThan {
...
namespace Messenger {
class Lifespan_Export MessageTypeSupportImpl
...
#endif /* OPENDDS_IDL_GENERATED_MESSENGERTYPESUPPORTIMPL_H_EXGHPX */
