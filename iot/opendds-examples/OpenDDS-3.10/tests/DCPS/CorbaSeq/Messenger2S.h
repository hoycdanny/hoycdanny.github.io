...
#ifndef _TAO_IDL_MESSENGER2S_X90CNH_H_
#define _TAO_IDL_MESSENGER2S_X90CNH_H_
...
namespace TAO
{
  ...
  template<>
  class SArg_Traits< ::Messenger2::LongSeq>
    : public
  ...
  template<>
  class SArg_Traits< ::Messenger2::Message2>
    : public
        Var_Size_SArg_Traits_T<
            ::Messenger2::Message2,
            TAO::Any_Insert_Policy_Noop
