...
#ifndef _TAO_IDL_MESSENGERS_RYB396_H_
#define _TAO_IDL_MESSENGERS_RYB396_H_
...
namespace TAO
{
  ...
  template<>
  class SArg_Traits< ::Messenger::BoundedCharSeq>
    : public
  ...
  template<>
  class SArg_Traits< ::Messenger::BoundedWCharSeq>
    : public
        Var_Size_SArg_Traits_T<
