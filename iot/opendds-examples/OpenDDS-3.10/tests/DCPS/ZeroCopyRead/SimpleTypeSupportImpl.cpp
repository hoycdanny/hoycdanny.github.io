...
void gen_find_size(const Test::LongSeq& seq, size_t& size, size_t& padding)
{
  ACE_UNUSED_ARG(seq);
  ACE_UNUSED_ARG(size);
...
bool operator<<(Serializer& strm, const Test::LongSeq& seq)
{
  ACE_UNUSED_ARG(strm);
  ACE_UNUSED_ARG(seq);
...
bool operator>>(Serializer& strm, Test::LongSeq& seq)
{
  ACE_UNUSED_ARG(strm);
  ACE_UNUSED_ARG(seq);
  CORBA::ULong length;
...
void gen_skip_over(Serializer& ser, Test::LongSeq*)
{
  ACE_UNUSED_ARG(ser);
...
void gen_find_size(const Test::Simple& stru, size_t& size, size_t& padding)
{
  ...
  gen_find_size(stru.ls, size, padding);
}
...
struct MetaStructImpl<Test::Simple> : MetaStruct {
  ...
  Value getValue(Serializer& ser, const char* field) const
  {
    ...
    gen_skip_over(ser, static_cast<Test::LongSeq*>(0));
    if (!field[0]) {
      return 0;
    }
  ...
  {
    static const char* names[] = {"key", "count", "text", "ls", 0};
    return names;
  }
  ...
  const void* getRawField(const void* stru, const char* field) const
  {
    ...
    if (std::strcmp(field, "ls") == 0) {
      return &static_cast<const T*>(stru)->ls;
    }
    throw std::runtime_error("Field " + OPENDDS_STRING(field) + " not found or its type is not supported (in struct Test::Simple)");
  }
    ...
    const char* rhsFieldSpec, const MetaStruct& rhsMeta) const
  {
    ...
    if (std::strcmp(field, "ls") == 0) {
      static_cast<T*>(lhs)->ls = *static_cast<const Test::LongSeq*>(rhsMeta.getRawField(rhs, rhsFieldSpec));
      return;
    }
    throw std::runtime_error("Field " + OPENDDS_STRING(field) + " not found or its type is not supported (in struct Test::Simple)");
  }
