...
#ifndef OPENDDS_IDL_GENERATED_MESSENGERTYPESUPPORTIMPL_H_RJGCTN
#define OPENDDS_IDL_GENERATED_MESSENGERTYPESUPPORTIMPL_H_RJGCTN
...
struct SubInitLoop_Export Message_OpenDDS_KeyLessThan {
...
namespace Messenger {
class SubInitLoop_Export MessageTypeSupportImpl
...
#endif /* OPENDDS_IDL_GENERATED_MESSENGERTYPESUPPORTIMPL_H_RJGCTN */
