...
#ifndef OPENDDS_IDL_GENERATED_MESSENGERTYPESUPPORTIMPL_H_CWTOIA
#define OPENDDS_IDL_GENERATED_MESSENGERTYPESUPPORTIMPL_H_CWTOIA
...
struct ManualAssertLiveliness_Export Message_OpenDDS_KeyLessThan {
...
namespace Messenger {
class ManualAssertLiveliness_Export MessageTypeSupportImpl
...
#endif /* OPENDDS_IDL_GENERATED_MESSENGERTYPESUPPORTIMPL_H_CWTOIA */
