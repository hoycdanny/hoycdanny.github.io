...
namespace T1 {
::DDS::DataWriter_ptr Foo1TypeSupportImpl::create_datawriter()
{
  typedef OpenDDS::DCPS::DataWriterImpl_T<Foo1> DataWriterImplType;
  ::DDS::DataWriter_ptr writer_impl = ::DDS::DataWriter::_nil();
  ACE_NEW_NORETURN(writer_impl,
                   DataWriterImplType());
  return writer_impl;
}
::DDS::DataReader_ptr Foo1TypeSupportImpl::create_datareader()
{
  typedef OpenDDS::DCPS::DataReaderImpl_T<Foo1> DataReaderImplType;
...
::DDS::DataReader_ptr Foo1TypeSupportImpl::create_multitopic_datareader()
{
  typedef OpenDDS::DCPS::DataReaderImpl_T<Foo1> DataReaderImplType;
  typedef OpenDDS::DCPS::MultiTopicDataReader_T<Foo1, DataReaderImplType> MultiTopicDataReaderImplType;
...
const OpenDDS::DCPS::MetaStruct& Foo1TypeSupportImpl::getMetaStructForType()
{
  return OpenDDS::DCPS::getMetaStruct<Foo1>();
}
#endif /* !OPENDDS_NO_CONTENT_SUBSCRIPTION_PROFILE */
bool Foo1TypeSupportImpl::has_dcps_key()
{
  return TraitsType::gen_has_key ();
}
const char* Foo1TypeSupportImpl::default_type_name() const
{
  return TraitsType::type_name();
}
Foo1TypeSupport::_ptr_type Foo1TypeSupportImpl::_narrow(CORBA::Object_ptr obj)
{
...
template<>
struct MetaStructImpl<T1::Foo1> : MetaStruct {
  typedef T1::Foo1 T;
  ...
  {
    const T1::Foo1& typed = *static_cast<const T1::Foo1*>(stru);
    ...
    throw std::runtime_error("Field " + OPENDDS_STRING(field) + " not found or its type is not supported (in struct T1::Foo1)");
  }
  ...
  Value getValue(Serializer& ser, const char* field) const
  {
    ...
    throw std::runtime_error("Field " + OPENDDS_STRING(field) + " not valid for struct T1::Foo1");
  }
...
{
  static MetaStructImpl<T1::Foo1> msi;
  return msi;
}
...
{
  ACE_UNUSED_ARG(ser);
  MetaStructImpl<T1::Foo1>().getValue(ser, "");
}
