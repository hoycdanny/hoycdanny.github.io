...
#include "Foo2DefTypeSupportImpl.h"
...
namespace T2 {
::DDS::DataWriter_ptr Foo2TypeSupportImpl::create_datawriter()
{
  typedef OpenDDS::DCPS::DataWriterImpl_T<Foo2> DataWriterImplType;
  ::DDS::DataWriter_ptr writer_impl = ::DDS::DataWriter::_nil();
  ACE_NEW_NORETURN(writer_impl,
                   DataWriterImplType());
  return writer_impl;
}
::DDS::DataReader_ptr Foo2TypeSupportImpl::create_datareader()
{
  typedef OpenDDS::DCPS::DataReaderImpl_T<Foo2> DataReaderImplType;
...
::DDS::DataReader_ptr Foo2TypeSupportImpl::create_multitopic_datareader()
{
  typedef OpenDDS::DCPS::DataReaderImpl_T<Foo2> DataReaderImplType;
  typedef OpenDDS::DCPS::MultiTopicDataReader_T<Foo2, DataReaderImplType> MultiTopicDataReaderImplType;
...
const OpenDDS::DCPS::MetaStruct& Foo2TypeSupportImpl::getMetaStructForType()
{
  return OpenDDS::DCPS::getMetaStruct<Foo2>();
}
#endif /* !OPENDDS_NO_CONTENT_SUBSCRIPTION_PROFILE */
bool Foo2TypeSupportImpl::has_dcps_key()
{
  return TraitsType::gen_has_key ();
}
const char* Foo2TypeSupportImpl::default_type_name() const
{
  return TraitsType::type_name();
}
Foo2TypeSupport::_ptr_type Foo2TypeSupportImpl::_narrow(CORBA::Object_ptr obj)
{
...
template<>
struct MetaStructImpl<T2::Foo2> : MetaStruct {
  typedef T2::Foo2 T;
  ...
  {
    const T2::Foo2& typed = *static_cast<const T2::Foo2*>(stru);
    ...
    throw std::runtime_error("Field " + OPENDDS_STRING(field) + " not found or its type is not supported (in struct T2::Foo2)");
  }
  ...
  Value getValue(Serializer& ser, const char* field) const
  {
    ...
    throw std::runtime_error("Field " + OPENDDS_STRING(field) + " not valid for struct T2::Foo2");
  }
  ...
  {
    static const char* names[] = {"key", "text", 0};
    return names;
  }
...
{
  static MetaStructImpl<T2::Foo2> msi;
  return msi;
}
...
{
  ACE_UNUSED_ARG(ser);
  MetaStructImpl<T2::Foo2>().getValue(ser, "");
}
