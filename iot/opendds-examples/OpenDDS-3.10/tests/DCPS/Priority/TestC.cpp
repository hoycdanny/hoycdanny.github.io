    ...
    const Test::Data &_tao_aggregate)
{
  return
    ...
    (strm << ::ACE_OutputCDR::from_boolean (_tao_aggregate.priority)) &&
    (strm << _tao_aggregate.before_value) &&
    (strm << _tao_aggregate.baggage);
}
    ...
    Test::Data &_tao_aggregate)
{
  return
    (strm >> _tao_aggregate.key) &&
    (strm >> _tao_aggregate.value) &&
    (strm >> ::ACE_InputCDR::to_boolean (_tao_aggregate.priority)) &&
    (strm >> _tao_aggregate.before_value) &&
    (strm >> _tao_aggregate.baggage);
}
