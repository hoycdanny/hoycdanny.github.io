...
#ifndef OPENDDS_IDL_GENERATED_FOODEFTYPESUPPORTIMPL_H_5ASUMQ
#define OPENDDS_IDL_GENERATED_FOODEFTYPESUPPORTIMPL_H_5ASUMQ
#include "FooDefC.h"
...
struct FooLib_Export Foo_OpenDDS_KeyLessThan {
  bool operator()(const Xyz::Foo& v1, const Xyz::Foo& v2) const
  {
    ...
    if (v1.data_source < v2.data_source) return true;
    if (v2.data_source < v1.data_source) return false;
    return false;
  }
};
}
...
template <>
struct MarshalTraits<Xyz::FooNoKey> {
  static bool gen_is_bounded_size() { return false; }
  static bool gen_is_bounded_key_size() { return true; }
};
}  }
...
// This structure supports use of std::map with a key
// defined by one or more #pragma DCPS_DATA_KEY lines.
struct FooLib_Export FooNoKey_OpenDDS_KeyLessThan {
  bool operator()(const Xyz::FooNoKey&, const Xyz::FooNoKey&) const
  {
...
namespace Xyz {
class FooNoKeyTypeSupportImpl;
}

OPENDDS_BEGIN_VERSIONED_NAMESPACE_DECL
namespace OpenDDS { namespace DCPS {
template <>
struct DDSTraits<Xyz::FooNoKey> {
  typedef Xyz::FooNoKey MessageType;
  typedef Xyz::FooNoKeySeq MessageSequenceType;
  typedef Xyz::FooNoKeyTypeSupport TypeSupportType;
  typedef Xyz::FooNoKeyTypeSupportImpl TypeSupportTypeImpl;
  typedef Xyz::FooNoKeyDataWriter DataWriterType;
  typedef Xyz::FooNoKeyDataReader DataReaderType;
  typedef Xyz::FooNoKey_OpenDDS_KeyLessThan LessThanType;

  static const char* type_name () { return "Xyz::FooNoKey"; }
...
namespace Xyz {
class FooLib_Export FooNoKeyTypeSupportImpl
  : public virtual OpenDDS::DCPS::LocalObject<FooNoKeyTypeSupport>
  , public virtual OpenDDS::DCPS::TypeSupportImpl
{
public:
  typedef OpenDDS::DCPS::DDSTraits<FooNoKey> TraitsType;
  typedef FooNoKeyTypeSupport TypeSupportType;
  typedef FooNoKeyTypeSupport::_var_type _var_type;
  typedef FooNoKeyTypeSupport::_ptr_type _ptr_type;

  FooNoKeyTypeSupportImpl() {}
  virtual ~FooNoKeyTypeSupportImpl() {}
  ...
  virtual bool has_dcps_key();
  const char* default_type_name() const;
  static FooNoKeyTypeSupport::_ptr_type _narrow(CORBA::Object_ptr obj);
};
}
...
/* End MODULE: Xyz */
#endif /* OPENDDS_IDL_GENERATED_FOODEFTYPESUPPORTIMPL_H_5ASUMQ */
