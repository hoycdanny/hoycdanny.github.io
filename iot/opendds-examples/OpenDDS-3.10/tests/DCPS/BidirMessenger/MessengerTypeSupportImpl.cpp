...
void gen_find_size(const Messenger::Message& stru, size_t& size, size_t& padding)
{
  ...
  size += gen_max_marshaled_size(stru.source_pid);
...
struct MetaStructImpl<Messenger::Message> : MetaStruct {
  ...
  Value getValue(const void* stru, const char* field) const
  {
    ...
    if (std::strcmp(field, "source_pid") == 0) {
      return typed.source_pid;
    }
  ...
  Value getValue(Serializer& ser, const char* field) const
  {
    if (std::strcmp(field, "source_pid") == 0) {
      ACE_CDR::Long val;
      if (!(ser >> val)) {
        throw std::runtime_error("Field 'source_pid' could not be deserialized");
      }
      return val;
    } else {
      ser.skip(1, 4);
  ...
  ComparatorBase::Ptr create_qc_comparator(const char* field, ComparatorBase::Ptr next) const
  {
    ACE_UNUSED_ARG(next);
    if (std::strcmp(field, "source_pid") == 0) {
      return make_field_cmp(&T::source_pid, next);
    }
    if (std::strcmp(field, "from") == 0) {
  ...
  {
    static const char* names[] = {"source_pid", "from", "subject", "subject_id", "text", "count", 0};
    return names;
  }
  ...
  {
    if (std::strcmp(field, "source_pid") == 0) {
      return &static_cast<const T*>(stru)->source_pid;
    }
    if (std::strcmp(field, "from") == 0) {
    ...
    const char* rhsFieldSpec, const MetaStruct& rhsMeta) const
  {
    ...
    if (std::strcmp(field, "source_pid") == 0) {
      static_cast<T*>(lhs)->source_pid = *static_cast<const CORBA::Long*>(rhsMeta.getRawField(rhs, rhsFieldSpec));
      return;
    }
    if (std::strcmp(field, "from") == 0) {
  ...
  bool compare(const void* lhs, const void* rhs, const char* field) const
  {
    ...
    ACE_UNUSED_ARG(rhs);
    if (std::strcmp(field, "source_pid") == 0) {
      return static_cast<const T*>(lhs)->source_pid == static_cast<const T*>(rhs)->source_pid;
    }
    if (std::strcmp(field, "from") == 0) {
