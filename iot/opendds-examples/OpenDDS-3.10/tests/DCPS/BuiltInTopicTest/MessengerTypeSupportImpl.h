...
#ifndef OPENDDS_IDL_GENERATED_MESSENGERTYPESUPPORTIMPL_H_RJDWMH
#define OPENDDS_IDL_GENERATED_MESSENGERTYPESUPPORTIMPL_H_RJDWMH
...
struct BuiltInTopicTest_Export Message_OpenDDS_KeyLessThan {
...
namespace Messenger {
class BuiltInTopicTest_Export MessageTypeSupportImpl
...
#endif /* OPENDDS_IDL_GENERATED_MESSENGERTYPESUPPORTIMPL_H_RJDWMH */
