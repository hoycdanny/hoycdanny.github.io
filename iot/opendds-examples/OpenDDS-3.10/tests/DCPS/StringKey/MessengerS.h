...
#ifndef _TAO_IDL_MESSENGERS_P6RJOV_H_
#define _TAO_IDL_MESSENGERS_P6RJOV_H_
...
namespace TAO
{
  ...
  template<>
  class SArg_Traits< ::Messenger::MyEnum>
    : public
        Basic_SArg_Traits_T<
            ::Messenger::MyEnum,
  ...
  template<>
  class SArg_Traits< ::Messenger::MyUnion>
    : public
  ...
  template<>
  class SArg_Traits< ::Messenger::Enums_tag>
    : public
  ...
  template<>
  class SArg_Traits< ::Messenger::EnumSeq>
    : public
