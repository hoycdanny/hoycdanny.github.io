...
void gen_find_size(const Messenger::Message& stru, size_t& size, size_t& padding)
{
  ...
  size += gen_max_marshaled_size(stru.reading);
  if ((size + padding) % 4) {
    padding += 4 - ((size + padding) % 4);
  }
...
struct MetaStructImpl<Messenger::Message> : MetaStruct {
  ...
  Value getValue(Serializer& ser, const char* field) const
  {
    ...
    if (std::strcmp(field, "reading") == 0) {
      ACE_CDR::Double val;
      if (!(ser >> val)) {
        throw std::runtime_error("Field 'reading' could not be deserialized");
      }
      return val;
    } else {
      ser.skip(1, 8);
  ...
  ComparatorBase::Ptr create_qc_comparator(const char* field, ComparatorBase::Ptr next) const
  {
    ...
    if (std::strcmp(field, "reading") == 0) {
      return make_field_cmp(&T::reading, next);
    }
    if (std::strcmp(field, "subject_id") == 0) {
  ...
  {
    static const char* names[] = {"count", "reading", "subject_id", 0};
    return names;
  }
  ...
  const void* getRawField(const void* stru, const char* field) const
  {
    ...
    if (std::strcmp(field, "reading") == 0) {
      return &static_cast<const T*>(stru)->reading;
    }
    if (std::strcmp(field, "subject_id") == 0) {
    ...
    const char* rhsFieldSpec, const MetaStruct& rhsMeta) const
  {
    ...
    if (std::strcmp(field, "reading") == 0) {
      static_cast<T*>(lhs)->reading = *static_cast<const CORBA::Double*>(rhsMeta.getRawField(rhs, rhsFieldSpec));
      return;
    }
    if (std::strcmp(field, "subject_id") == 0) {
  ...
  bool compare(const void* lhs, const void* rhs, const char* field) const
  {
    ...
    if (std::strcmp(field, "reading") == 0) {
      return static_cast<const T*>(lhs)->reading == static_cast<const T*>(rhs)->reading;
    }
    if (std::strcmp(field, "subject_id") == 0) {
