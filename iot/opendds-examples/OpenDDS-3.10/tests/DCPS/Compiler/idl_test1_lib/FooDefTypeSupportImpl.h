...
#ifndef OPENDDS_IDL_GENERATED_FOODEFTYPESUPPORTIMPL_H_SMQBRW
#define OPENDDS_IDL_GENERATED_FOODEFTYPESUPPORTIMPL_H_SMQBRW
#include "FooDefC.h"
...
/* End STRUCT: Bar */
#endif /* OPENDDS_IDL_GENERATED_FOODEFTYPESUPPORTIMPL_H_SMQBRW */
