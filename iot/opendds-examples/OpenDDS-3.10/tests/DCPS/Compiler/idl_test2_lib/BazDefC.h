...
#ifndef _TAO_IDL_BAZDEFC_OZ4T4G_H_
#define _TAO_IDL_BAZDEFC_OZ4T4G_H_
...
FooLib_Export ::CORBA::Boolean operator<< (TAO_OutputCDR &, const Xyz::Baz &);
FooLib_Export ::CORBA::Boolean operator>> (TAO_InputCDR &, Xyz::Baz &);
