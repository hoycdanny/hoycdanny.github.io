...
void gen_find_size(const Messenger::Message& stru, size_t& size, size_t& padding)
{
  ...
  size += gen_max_marshaled_size(stru.phase_number);
  find_size_ulong(size, padding);
...
struct MetaStructImpl<Messenger::Message> : MetaStruct {
  ...
  Value getValue(const void* stru, const char* field) const
  {
    ...
    if (std::strcmp(field, "phase_number") == 0) {
      return typed.phase_number;
    }
  ...
  Value getValue(Serializer& ser, const char* field) const
  {
    ...
    if (std::strcmp(field, "phase_number") == 0) {
      ACE_CDR::Long val;
      if (!(ser >> val)) {
        throw std::runtime_error("Field 'phase_number' could not be deserialized");
      }
      return val;
    } else {
      ser.skip(1, 4);
  ...
  ComparatorBase::Ptr create_qc_comparator(const char* field, ComparatorBase::Ptr next) const
  {
    ...
    if (std::strcmp(field, "phase_number") == 0) {
      return make_field_cmp(&T::phase_number, next);
    }
    if (std::strcmp(field, "text") == 0) {
  ...
  {
    static const char* names[] = {"from", "subject", "subject_id", "phase_number", "text", "count", 0};
    return names;
  }
  ...
  const void* getRawField(const void* stru, const char* field) const
  {
    ...
    if (std::strcmp(field, "phase_number") == 0) {
      return &static_cast<const T*>(stru)->phase_number;
    }
    if (std::strcmp(field, "text") == 0) {
    ...
    const char* rhsFieldSpec, const MetaStruct& rhsMeta) const
  {
    ...
    if (std::strcmp(field, "phase_number") == 0) {
      static_cast<T*>(lhs)->phase_number = *static_cast<const CORBA::Long*>(rhsMeta.getRawField(rhs, rhsFieldSpec));
      return;
    }
    if (std::strcmp(field, "text") == 0) {
  ...
  bool compare(const void* lhs, const void* rhs, const char* field) const
  {
    ...
    if (std::strcmp(field, "phase_number") == 0) {
      return static_cast<const T*>(lhs)->phase_number == static_cast<const T*>(rhs)->phase_number;
    }
    if (std::strcmp(field, "text") == 0) {
