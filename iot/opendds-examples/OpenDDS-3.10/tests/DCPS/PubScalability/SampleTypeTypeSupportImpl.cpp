...
namespace Xyz {
::DDS::DataWriter_ptr SampleTypeTypeSupportImpl::create_datawriter()
{
  typedef OpenDDS::DCPS::DataWriterImpl_T<SampleType> DataWriterImplType;
  ::DDS::DataWriter_ptr writer_impl = ::DDS::DataWriter::_nil();
  ACE_NEW_NORETURN(writer_impl,
                   DataWriterImplType());
  return writer_impl;
}
::DDS::DataReader_ptr SampleTypeTypeSupportImpl::create_datareader()
{
  typedef OpenDDS::DCPS::DataReaderImpl_T<SampleType> DataReaderImplType;
...
::DDS::DataReader_ptr SampleTypeTypeSupportImpl::create_multitopic_datareader()
{
  typedef OpenDDS::DCPS::DataReaderImpl_T<SampleType> DataReaderImplType;
  typedef OpenDDS::DCPS::MultiTopicDataReader_T<SampleType, DataReaderImplType> MultiTopicDataReaderImplType;
...
const OpenDDS::DCPS::MetaStruct& SampleTypeTypeSupportImpl::getMetaStructForType()
{
  return OpenDDS::DCPS::getMetaStruct<SampleType>();
}
#endif /* !OPENDDS_NO_CONTENT_SUBSCRIPTION_PROFILE */
bool SampleTypeTypeSupportImpl::has_dcps_key()
{
  return TraitsType::gen_has_key ();
}
const char* SampleTypeTypeSupportImpl::default_type_name() const
{
  return TraitsType::type_name();
}
SampleTypeTypeSupport::_ptr_type SampleTypeTypeSupportImpl::_narrow(CORBA::Object_ptr obj)
{
...
template<>
struct MetaStructImpl<Xyz::SampleType> : MetaStruct {
  typedef Xyz::SampleType T;
  ...
  {
    const Xyz::SampleType& typed = *static_cast<const Xyz::SampleType*>(stru);
    ...
    throw std::runtime_error("Field " + OPENDDS_STRING(field) + " not found or its type is not supported (in struct Xyz::SampleType)");
  }
  ...
  Value getValue(Serializer& ser, const char* field) const
  {
    ...
    throw std::runtime_error("Field " + OPENDDS_STRING(field) + " not valid for struct Xyz::SampleType");
  }
...
{
  static MetaStructImpl<Xyz::SampleType> msi;
  return msi;
}
...
{
  ACE_UNUSED_ARG(ser);
  MetaStructImpl<Xyz::SampleType>().getValue(ser, "");
}
