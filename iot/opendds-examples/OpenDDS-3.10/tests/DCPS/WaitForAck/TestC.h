...
#ifndef _TAO_IDL_TESTC_I26ILS_H_
#define _TAO_IDL_TESTC_I26ILS_H_
...
#define _TEST_OCTETSEQ_CH_
  ...
  class WaitForAck_Export OctetSeq
    : public
...
WaitForAck_Export ::CORBA::Boolean operator<< (
    TAO_OutputCDR &strm,
...
WaitForAck_Export ::CORBA::Boolean operator<< (TAO_OutputCDR &, const Test::Data &);
WaitForAck_Export ::CORBA::Boolean operator>> (TAO_InputCDR &, Test::Data &);
