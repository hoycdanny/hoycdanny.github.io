...
#ifndef _TAO_IDL_MESSENGERC_7UFGGF_H_
#define _TAO_IDL_MESSENGERC_7UFGGF_H_
...
namespace TAO
{
  ...
  template<>
  class Arg_Traits< ::Messenger::Nested>
    : public
...
TAO_BEGIN_VERSIONED_NAMESPACE_DECL
 ...
 ::CORBA::Boolean operator<< (TAO_OutputCDR &, const Messenger::Nested &);
 ::CORBA::Boolean operator>> (TAO_InputCDR &, Messenger::Nested &);
