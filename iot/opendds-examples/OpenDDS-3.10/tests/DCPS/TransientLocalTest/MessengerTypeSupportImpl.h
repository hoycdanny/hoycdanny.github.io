...
#ifndef OPENDDS_IDL_GENERATED_MESSENGERTYPESUPPORTIMPL_H_XHBMMR
#define OPENDDS_IDL_GENERATED_MESSENGERTYPESUPPORTIMPL_H_XHBMMR
...
struct TransientLocalTest_Export Message_OpenDDS_KeyLessThan {
...
namespace Messenger {
class TransientLocalTest_Export MessageTypeSupportImpl
...
#endif /* OPENDDS_IDL_GENERATED_MESSENGERTYPESUPPORTIMPL_H_XHBMMR */
