...
namespace Ex {
::DDS::DataWriter_ptr TestTypeSupportImpl::create_datawriter()
{
  typedef OpenDDS::DCPS::DataWriterImpl_T<Test> DataWriterImplType;
  ::DDS::DataWriter_ptr writer_impl = ::DDS::DataWriter::_nil();
  ACE_NEW_NORETURN(writer_impl,
                   DataWriterImplType());
  return writer_impl;
}
::DDS::DataReader_ptr TestTypeSupportImpl::create_datareader()
{
  typedef OpenDDS::DCPS::DataReaderImpl_T<Test> DataReaderImplType;
...
::DDS::DataReader_ptr TestTypeSupportImpl::create_multitopic_datareader()
{
  typedef OpenDDS::DCPS::DataReaderImpl_T<Test> DataReaderImplType;
  typedef OpenDDS::DCPS::MultiTopicDataReader_T<Test, DataReaderImplType> MultiTopicDataReaderImplType;
...
const OpenDDS::DCPS::MetaStruct& TestTypeSupportImpl::getMetaStructForType()
{
  return OpenDDS::DCPS::getMetaStruct<Test>();
}
#endif /* !OPENDDS_NO_CONTENT_SUBSCRIPTION_PROFILE */
bool TestTypeSupportImpl::has_dcps_key()
{
  return TraitsType::gen_has_key ();
}
const char* TestTypeSupportImpl::default_type_name() const
{
  return TraitsType::type_name();
}
TestTypeSupport::_ptr_type TestTypeSupportImpl::_narrow(CORBA::Object_ptr obj)
{
...
template<>
struct MetaStructImpl<Ex::Test> : MetaStruct {
  typedef Ex::Test T;
  ...
  {
    const Ex::Test& typed = *static_cast<const Ex::Test*>(stru);
    ...
    throw std::runtime_error("Field " + OPENDDS_STRING(field) + " not found or its type is not supported (in struct Ex::Test)");
  }
  ...
  Value getValue(Serializer& ser, const char* field) const
  {
    ...
    throw std::runtime_error("Field " + OPENDDS_STRING(field) + " not valid for struct Ex::Test");
  }
...
{
  static MetaStructImpl<Ex::Test> msi;
  return msi;
}
...
{
  ACE_UNUSED_ARG(ser);
  MetaStructImpl<Ex::Test>().getValue(ser, "");
}
