...
#ifndef OPENDDS_IDL_GENERATED_MESSENGERTYPESUPPORTIMPL_H_XZEIUK
#define OPENDDS_IDL_GENERATED_MESSENGERTYPESUPPORTIMPL_H_XZEIUK
...
struct NotifyTest_Export Message_OpenDDS_KeyLessThan {
...
namespace Messenger {
class NotifyTest_Export MessageTypeSupportImpl
...
#endif /* OPENDDS_IDL_GENERATED_MESSENGERTYPESUPPORTIMPL_H_XZEIUK */
