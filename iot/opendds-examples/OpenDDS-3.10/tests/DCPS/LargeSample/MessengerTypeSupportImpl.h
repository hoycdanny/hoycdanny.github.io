...
#ifndef OPENDDS_IDL_GENERATED_MESSENGERTYPESUPPORTIMPL_H_0JEYJD
#define OPENDDS_IDL_GENERATED_MESSENGERTYPESUPPORTIMPL_H_0JEYJD
...
struct LargeSample_Export Message_OpenDDS_KeyLessThan {
  bool operator()(const Messenger::Message& v1, const Messenger::Message& v2) const
  {
    using ::operator<; // TAO::String_Manager's operator< is in global NS
    if (v1.writer_id < v2.writer_id) return true;
    if (v2.writer_id < v1.writer_id) return false;
    return false;
  }
};
}
...
namespace Messenger {
class LargeSample_Export MessageTypeSupportImpl
...
#endif /* OPENDDS_IDL_GENERATED_MESSENGERTYPESUPPORTIMPL_H_0JEYJD */
