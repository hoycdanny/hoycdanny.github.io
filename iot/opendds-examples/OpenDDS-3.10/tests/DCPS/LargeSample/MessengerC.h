...
#ifndef _TAO_IDL_MESSENGERC_06QHAM_H_
#define _TAO_IDL_MESSENGERC_06QHAM_H_
...
#if !defined (_MESSENGER_OCTETSEQ_CH_)
#define _MESSENGER_OCTETSEQ_CH_
  ...
  class LargeSample_Export OctetSeq
    : public
  ...
  struct LargeSample_Export Message
  {
    ...
    ::CORBA::Long sample_id;
    Messenger::OctetSeq data;
  };
...
namespace TAO
{
  ...
  template<>
  class Arg_Traits< ::Messenger::OctetSeq>
    : public
...
#if !defined _TAO_CDR_OP_Messenger_OctetSeq_H_
#define _TAO_CDR_OP_Messenger_OctetSeq_H_
TAO_BEGIN_VERSIONED_NAMESPACE_DECL


LargeSample_Export ::CORBA::Boolean operator<< (
    TAO_OutputCDR &strm,
...
#endif /* _TAO_CDR_OP_Messenger_OctetSeq_H_ */
...
LargeSample_Export ::CORBA::Boolean operator<< (TAO_OutputCDR &, const Messenger::Message &);
LargeSample_Export ::CORBA::Boolean operator>> (TAO_InputCDR &, Messenger::Message &);
