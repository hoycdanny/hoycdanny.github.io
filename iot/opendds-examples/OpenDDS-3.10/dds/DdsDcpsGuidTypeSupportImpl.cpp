...
struct MetaStructImpl<OpenDDS::DCPS::EntityId_t> : MetaStruct {
  ...
  Value getValue(Serializer& ser, const char* field) const
  {
    ...
    throw std::runtime_error("Field " + OPENDDS_STRING(field) + " not valid for struct OpenDDS::DCPS::EntityId_t");
  }
...
struct MetaStructImpl<OpenDDS::DCPS::GUID_t> : MetaStruct {
  ...
  Value getValue(Serializer& ser, const char* field) const
  {
    ...
    throw std::runtime_error("Field " + OPENDDS_STRING(field) + " not valid for struct OpenDDS::DCPS::GUID_t");
  }
