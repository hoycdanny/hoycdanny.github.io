...
#ifndef _TAO_IDL_INFOS_XO2VMD_CPP_
#define _TAO_IDL_INFOS_XO2VMD_CPP_
...
/* Command-line: /Users/yc/MyGithub/imac-project/OpenDDS/OpenDDS-3.10/ACE_wrappers/bin/ace_gperf -m -M -J -c -C -D -E -T -f 0 -F 0,0 -a -o -t -p -K opname -L C++ -Z TAO_OpenDDS_DCPS_DCPSInfo_Perfect_Hash_OpTable -N lookup  */
unsigned int
  ...
  namespace DCPS
  {
    ...
    public:
      ...
      virtual void execute (void)
      {
        ...
        TAO::SArg_Traits< char *>::in_arg_type arg_9 =
          TAO::Portable_Server::get_in_arg< char *> (
            this->operation_details_,
            this->args_,
            9);
          
        TAO::SArg_Traits< ::DDS::StringSeq>::in_arg_type arg_10 =
  ...
  TAO_ServantBase *servant)
{
  ...
  TAO::SArg_Traits< char *>::in_arg_val _tao_filterClassName;
