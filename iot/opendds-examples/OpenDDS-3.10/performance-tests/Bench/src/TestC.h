...
#ifndef _TAO_IDL_TESTC_TFO8YM_H_
#define _TAO_IDL_TESTC_TFO8YM_H_
...
TAO_BEGIN_VERSIONED_NAMESPACE_DECL
 ...
 ::CORBA::Boolean operator<< (TAO_OutputCDR &, const Test::Data &);
 ::CORBA::Boolean operator>> (TAO_InputCDR &, Test::Data &);
